...
apptainer exec --bind /fs/scratch/PAS2658/Alexis/Annotation/Funannotate_pipeline/data/database:/data/database /fs/scratch/PAS2658/Alexis/Annotation/Software/NewFunannotate.sif funannotate annotate -i /fs/scratch/PAS2658/Alexis/Annotation/Funannotate_pipeline/Peltaster_fructicola --busco_db /fs/scratch/PAS2658/Alexis/Annotation/Funannotate_pipeline/data/database/dothideomycetes_odb10 --cpus 28 --force
EOF
```
Then, we send it to the scheduler:
```
