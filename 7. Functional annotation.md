...
apptainer run --bind /fs/scratch/PAS2658/Alexis/Annotation/Funannotate_pipeline/data/database:/data/database /fs/scratch/PAS2658/Alexis/Annotation/Software/Funannotate.sif funannotate annotate -i /fs/scratch/PAS2658/Alexis/Annotation/Funannotate_pipeline/Peltaster_fructicola --busco_db dothideomycetes_odb10 --cpus 28 --force
EOF
```
Then, we send it to the scheduler:
```
